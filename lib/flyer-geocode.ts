...
export class FlyerGeocodeError extends Error {
  constructor(message: string) {
    super(message);
    this.name = "FlyerGeocodeError";
  }
}
...
export interface GeocodeFlyerResult {
  berhasil: number;
  gagal: number;
  dari_cache: number;
...
export async function geocodeFlyer(
  flyerId: string,
): Promise<GeocodeFlyerResult> {
